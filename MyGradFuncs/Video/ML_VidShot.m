...
% Requires: voc-release5 http://www.cs.berkeley.edu/~rbg/latent/ for HOG
%    and vl_feat for SIFT
    ...
    methods (Static)
        ...
        function shotBndIdxs = detectCuts(imFiles, verbose)
            ...
            for i=1:nFrm-1
                ...
                curImHog = ML_VidShot.cmpHogFeat(imread(imFiles{i+1}));
